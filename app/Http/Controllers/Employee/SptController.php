...
class SptController extends Controller
{
    ...
    {
        return view('employee.spt.index');
    }
    ...
    {
        return \view('employee.spt.create', [
    ...
    public function store(ReqSptController $request)
    {
        ...
        return \redirect()->route('employee.spt.index');
    }
    ...
    public function dtSpt()
    {
        ...
        return\datatables()->of($spt)
            ->addColumn('action', function($spt){
                $btn =  '
                    <a href="/employee/master/spt/' .$spt->id. '" class="btn btn-primary">Detail</a>
                    <a href="/employee/master/spt/' .$spt->id. '/edit" class="btn btn-warning">Edit</a>
