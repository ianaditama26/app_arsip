         ...
         <div class="card">
            <div class="card-header">
               ...
               <div class="card-header-action">
                  <a href="{{ route('employee.non-spt.create') }}" class="btn btn-primary">
                     Buat data non spt
                  </a>
               </div>
            </div>
   ...
   <div class="modal fade" tabindex="-1" role="dialog" id="exampleModal">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form action="{{ route('employee.non-spt.import') }}" method="post" enctype="multipart/form-data">
            @csrf
      ...
      $('#dataTable').on('click', '#delete', function(e){
         ...
         Swal.fire({
            ...
            if (result.value) {
               $.ajax({
                     type: "DELETE",
                     url: "/employee/master/non-spt/" + id, // /'prefixnya'/controler atau classnya
                     data: {
                        "id": id,
                        "_token": "{{ csrf_token() }}"
                     }, 
